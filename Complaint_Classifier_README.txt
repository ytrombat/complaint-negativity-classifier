...
```bash
python "AIT526_Team2_Project Merged.py"
```
This will:
- Load and clean complaint data.  
- Compute negativity metrics and generate labels.  
- Display visualizations and tables.  
- Train and evaluate both Logistic Regression and Neural Network models.  
